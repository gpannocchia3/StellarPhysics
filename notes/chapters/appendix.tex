\chapter{Appendix A: Radiative Transfer}
...
\par The equation of radiative transport in presence of scatteringz may be cast in a slightly different form 
\begin{equation*}
	I_{\nu} = S_{\nu}-\frac{\mu}{\alpha_{\nu}+\sigma_{\nu}}\partial_{z}I_{\nu}
\end{equation*}
